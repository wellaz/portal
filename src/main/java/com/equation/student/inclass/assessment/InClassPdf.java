...
public class InClassPdf {
	...
	public void generatePDF(Table table, Table table2, Button download, String studentname, String studentID,
			String class_name) {
		try {
			String filename = Filename.setFileName() + studentID + "_inclass_performance" + ".pdf";
			...
			document.add(new Paragraph(
					new DateUtility().timeStamp() + "In Class Test Continuous Assessment Report".toUpperCase(),
			...
			PdfPCell cell = new PdfPCell(new Paragraph("All In Class Test Continuous Assessment".toUpperCase(),
			...
			PdfPCell cell2 = new PdfPCell(new Paragraph("Per Subject In Class Test Continuous Assessment".toUpperCase(),
					FontFactory.getFont(FontFactory.TIMES_ROMAN, 15, com.itextpdf.text.Font.ITALIC, BaseColor.BLUE)));
			...
			document.add(new Paragraph("Subject Performance For All In Class Test",
