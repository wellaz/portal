...
public class MyPaymentreportPDF {

	public MyPaymentreportPDF() {
		super();
		return;
	}

	public void generatePDF(String studentID, String studentname, Table table, Button download) {
		try {
			...
			document.add(
					new Paragraph("Fees Payment Report for " + studentname.toUpperCase() + " From Inception To Date",
