...
public class IndividualPaymentReportPDF {

	public IndividualPaymentReportPDF() {

	}

	public void generatePDF(String studentID, String studentname, String term, String year, Table table,
			Button download) {
		try {
			String filename = studentID + "_paymemts" + ".pdf";
			...
			document.add(new Paragraph("Payment Report for " + studentname.toUpperCase() + " " + term + " " + year,
			...
			PdfPCell cell = new PdfPCell(new Paragraph(studentname.toUpperCase() + " Student ID " + studentID,
