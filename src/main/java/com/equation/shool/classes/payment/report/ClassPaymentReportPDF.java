...
public class ClassPaymentReportPDF {

	public ClassPaymentReportPDF() {

	}

	public void generatePDF(String classname, String term, String year, Table table, Button download) {
		try {
			String filename = classname + "_paymemts" + ".pdf";
			...
			document.add(new Paragraph("Payment Report for Class " + classname.toUpperCase() + " " + term + " " + year,
			...
			PdfPCell cell = new PdfPCell(new Paragraph(classname.toUpperCase() + " Payment Report",
