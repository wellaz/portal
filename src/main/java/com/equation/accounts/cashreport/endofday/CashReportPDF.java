...
public class CashReportPDF {

	public CashReportPDF() {

	}

	public void generatePDF(Table table, Button download) {
		try {
			String filename = Filename.setFileName() + "_CashReport" + ".pdf";
			Document document = new Document(PageSize.A4, 40, 40, 40, 40);

			// String path = System.getProperty("user.home") +
			// File.separatorChar + "Downloads" + File.separatorChar
			// + filename;
			...
			document.add(new Paragraph(new DateUtility().timeStamp() + " End of day Cash Report".toUpperCase(),
