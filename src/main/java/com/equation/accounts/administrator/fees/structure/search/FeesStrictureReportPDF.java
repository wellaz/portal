...
public class FeesStrictureReportPDF {

	public FeesStrictureReportPDF() {
	...
	public void generatePDF( Table table,Button download) {
		try {
			...
			document.add(new Paragraph("Fees Structure".toUpperCase(),
			...
			PdfPCell cell = new PdfPCell(new Paragraph("School Fees Breakdown Structure.".toUpperCase() + " Report",
