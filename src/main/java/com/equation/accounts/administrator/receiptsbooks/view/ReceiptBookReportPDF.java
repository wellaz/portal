...
public class ReceiptBookReportPDF {

	public ReceiptBookReportPDF() {

	}

	public void generatePDF(Table table, Button download) {
		try {
			String filename = Filename.setFileName() + "receipt_book_report" + ".pdf";
			...
			document.add(new Paragraph("Receipt BookS".toUpperCase(),
			...
			PdfPCell cell = new PdfPCell(new Paragraph("receit books".toUpperCase() + " Report",
