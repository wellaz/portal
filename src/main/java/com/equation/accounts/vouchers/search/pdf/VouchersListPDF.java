package com.equation.accounts.vouchers.search.pdf;
...
public class VouchersListPDF {

	public VouchersListPDF() {

	}

	public void generatePDF(Table table, Button download) {
		try {
			String filename = Filename.setFileName() + "voucherslist_report" + ".pdf";
			...
			document.add(new Paragraph("Vouchers File".toUpperCase(),
			...
			PdfPCell cell = new PdfPCell(new Paragraph("Vouchers compilation File".toUpperCase(),
