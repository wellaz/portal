...
import com.equation.utils.filesopener.OpenFile;
...
public class AutomaticVoucher {

	public AutomaticVoucher() {

	}

	public void generatePDF(Table table, String accountname) {
		try {
			String filename = Filename.setFileName() + "_Voucher" + ".pdf";
