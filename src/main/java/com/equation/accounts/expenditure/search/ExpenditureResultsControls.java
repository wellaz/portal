...
import com.equation.accounts.expenditure.pdf.ExpenditurePDF;
...
public class ExpenditureResultsControls extends HorizontalLayout {
	Window window;
	Table table;

	public ExpenditureResultsControls(Window window, Table table) {
		this.window = window;
		this.table = table;
		...
		ExpenditurePDF bankingRegisterPDF = new ExpenditurePDF();
