...
import com.equation.accounts.administrator.fees.structure.search.FeesStrictureReportPDF;
...
public class FeesStructureResultsControls extends HorizontalLayout {
	Window window;
	Table table;

	public FeesStructureResultsControls(Window window, Table table) {
		this.window = window;
		this.table = table;
		...
		FeesStrictureReportPDF bankingRegisterPDF = new FeesStrictureReportPDF();
		bankingRegisterPDF.generatePDF(table, download);
