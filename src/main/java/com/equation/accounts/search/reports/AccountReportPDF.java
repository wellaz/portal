package com.equation.accounts.search.reports;
...
public class AccountReportPDF {
	...
	public AccountReportPDF() {

	}

	public void generatePDF(String accountname, String from, String to, Table table, Button download) {
		try {
			String filename = Filename.setFileName() + "_" + accountname + "_paymemts" + ".pdf";
			...
			document.add(new Paragraph("Statement for " + accountname.toUpperCase() + " " + from + " - " + to,
			...
			PdfPCell cell = new PdfPCell(new Paragraph(accountname.toUpperCase() + " Report",
