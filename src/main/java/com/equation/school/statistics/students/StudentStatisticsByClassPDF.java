...
public class StudentStatisticsByClassPDF {

	public StudentStatisticsByClassPDF() {

	}

	public void generatePDF(String classname, Table table, Button download) {
		try {
			String filename = classname + "_StudentClassStatistics" + ".pdf";
			...
			document.add(new Paragraph("Statistics Report for " + classname.toUpperCase(),
