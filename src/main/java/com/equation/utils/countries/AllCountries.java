package com.equation.utils.countries;
...
public class AllCountries {
	static String[] mycountries = { "Afghanistan", "Albania", "Algeria", "American Samoa", "Andorra", "Angola",
			"Anguilla", "Antigua", "Barbuda", "Argentina", "Armenia", "Aruba", "Australia", "Austria", "Azerbaijan",
			"Bahamas", "The Bahrain", "Bangladesh", "Barbados", "Belarus", "Belgium", "Belize", "Benin", "Bermuda",
			"Bhutan", "Bolivia", "Bosnia & Herzegovina", "Botswana", "Brazil", "British Virgin", "Is.Brunei Bulgaria",
			"Burkina Faso", "Burma", "Burundi", "Cambodia", "Cameroon", "Canada", "Cape Verde", "Cayman",
			"Islands Central", "African Rep.", "Chad", "Chile", "China", "Colombia", "Comoros", "Congo",
			"Dem.Rep.Congo", "Repub. of the Cook Islands", "Costa Rica", "Cote d'I voire", "Croatia", "Cuba", "Cyprus",
			...
			"France", "French Guiana", "French Polynesia", "Gabon", "Gambia", "The Gaza Strip", "Georgia", "Germany",
			...
			"Martinique", "Mauritania", "Mauritius", "Mayotte", "Mexico", "Micronesia Fed.", "St.Moldova", "Monaco",
			...
			"N.Marian Islands", "Norway", "Oman", "Pakistan", "Palau", "Panama", "Papua New Guinea", "Paraguay", "Peru",
			"Philippines", "Poland", "Portugal", "Puerto Rico", "Qatar Reunion", "Romania", "Russia", "Rwanda",
			"Saint Helena", "Saint Kitts& Nevis", "Saint Lucia", "St Pierre& Miquelon",
			"Saint Vincent and the Grenadines", "Samoa", "San", "Marino", "Sao Tome& Principe", "Saudi Arabia",
			...
			"Turkey", "Turkmenistan", "Turks& Caicos Is", "Tuvalu", "Uganda", "Ukraine", "United Arab Emirates",
	...
	public static ArrayList<String> allCountriesCollection() {
