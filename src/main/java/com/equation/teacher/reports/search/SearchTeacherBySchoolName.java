...
public class SearchTeacherBySchoolName {

	ResultSet rs, rs1;
	Statement stm, stmt;
	private Table grid;

	public SearchTeacherBySchoolName(ResultSet rs, ResultSet rs1, Statement stm, Statement stmt) {
		this.rs = rs;
		this.rs1 = rs1;
		this.stm = stm;
		this.stmt = stmt;
	...
	public Panel createContetPanel(String schoolID) {
